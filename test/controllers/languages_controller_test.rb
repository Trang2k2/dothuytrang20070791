...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { movie_id: @language.movie_id, name: @language.name } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { movie_id: @language.movie_id, name: @language.name } }
